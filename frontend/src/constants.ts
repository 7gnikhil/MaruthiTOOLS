...
// Nav: Products first, then Tools & Machines sections, End Components last
export const NAV_LINKS_LEFT: Page[] = ['Products', 'Moulds', 'Machinery'];
export const NAV_LINKS_RIGHT: Page[] = ['End Components', 'Services', 'About Us', 'Contact Us', 'Careers'];
